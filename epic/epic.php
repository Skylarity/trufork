	...
	<body class="global">
		...
		<div class="full-width">
			<div class="container">
				...
				<p>A user has an ID and a password hash. One user has one profile. Many profiles can vote and comment on
					many restaurants, and friend many other profiles.</p>
