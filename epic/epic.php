   ...
   <body class="global">
      ...
      <div class="full-width">
         <div class="container">
            ...
            <p>A user has an ID and a password hash. One user has one profile. Many profiles can vote, like, and comment on many restaurants, and friend many other profiles. A restaurant has an ID, Google's restaurant ID, Google's rating, ABQ's restaurant ID, ABQ's inspection data, our TruFork rating, and an address.</p>
